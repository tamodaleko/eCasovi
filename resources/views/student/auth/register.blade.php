...
<div class="kt-login__head">
    ...
    <a href="{{ route('student.login') }}" class="kt-link kt-login__signup-link">{{ __('Login!') }}</a>
</div>
<!--end::Head-->
<br/>
<!--begin::Body-->
<div class="kt-login__body">
    <div class="kt-login__form">
        ...
        <!--begin::Form-->
        <form class="kt-form" action="{{ route('student.register') }}" novalidate="novalidate" id="kt_login_form" method="post">
            @csrf
