@extends('students.layouts.auth')

@section('content')
<!--begin::Head-->
<div class="kt-login__head">
    <span class="kt-login__signup-label">{{ __('Don\'t have an account yet?') }}</span>&nbsp;&nbsp;
    <a href="{{ route('student.register') }}" class="kt-link kt-login__signup-link">{{ __('Register!') }}</a>
</div>
<!--end::Head-->
...
<div class="kt-login__body">
    <div class="kt-login__form">
        <div class="kt-login__title">
            <h3>{{ __('Student Login') }}</h3>
        </div>

        <!--begin::Form-->
        <form class="kt-form" action="{{ route('student.login') }}" novalidate="novalidate" id="kt_login_form" method="post">
            @csrf
